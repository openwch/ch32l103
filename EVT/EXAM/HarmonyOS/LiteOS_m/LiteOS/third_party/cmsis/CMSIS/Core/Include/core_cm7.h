...
typedef struct
{
  ...
  __IOM uint32_t HBPCR;                 /*!< Offset: 0x298 (R/W)  HBP Control Register */
  __IOM uint32_t CACR;                   /*!< Offset: 0x29C (R/W)  L1 Cache Control Register */
  __IOM uint32_t HBSCR;                 /*!< Offset: 0x2A0 (R/W)  HB Slave Control Register */
...
/* HBP Control Register Definitions */
#define SCB_HBPCR_SZ_Pos                   1U                                            /*!< SCB HBPCR: SZ Position */
#define SCB_HBPCR_SZ_Msk                  (7UL << SCB_HBPCR_SZ_Pos)                     /*!< SCB HBPCR: SZ Mask */

#define SCB_HBPCR_EN_Pos                   0U                                            /*!< SCB HBPCR: EN Position */
#define SCB_HBPCR_EN_Msk                  (1UL /*<< SCB_HBPCR_EN_Pos*/)                 /*!< SCB HBPCR: EN Mask */
...
/* HBS Control Register Definitions */
#define SCB_HBSCR_INITCOUNT_Pos           11U                                            /*!< SCB HBSCR: INITCOUNT Position */
#define SCB_HBSCR_INITCOUNT_Msk           (0x1FUL << SCB_HBPCR_INITCOUNT_Pos)           /*!< SCB HBSCR: INITCOUNT Mask */

#define SCB_HBSCR_TPRI_Pos                 2U                                            /*!< SCB HBSCR: TPRI Position */
#define SCB_HBSCR_TPRI_Msk                (0x1FFUL << SCB_HBPCR_TPRI_Pos)               /*!< SCB HBSCR: TPRI Mask */

#define SCB_HBSCR_CTL_Pos                  0U                                            /*!< SCB HBSCR: CTL Position*/
#define SCB_HBSCR_CTL_Msk                 (3UL /*<< SCB_HBPCR_CTL_Pos*/)                /*!< SCB HBSCR: CTL Mask */
...
#define SCB_ABFSR_HBP_Pos                  2U                                            /*!< SCB ABFSR: HBP Position*/
#define SCB_ABFSR_HBP_Msk                 (1UL << SCB_ABFSR_HBP_Pos)                    /*!< SCB ABFSR: HBP Mask */
